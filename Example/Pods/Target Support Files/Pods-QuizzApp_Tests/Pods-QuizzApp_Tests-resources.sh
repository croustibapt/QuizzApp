...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/QuizzAppImage.bundle"
  install_resource "${BUILT_PRODUCTS_DIR}/QuizzAppENImage.bundle"
  install_resource "${BUILT_PRODUCTS_DIR}/QuizzAppFRImage.bundle"
